...
|--------|-------------|---------|
| [rapid](documentation/rapid.md) | Team-based parallel development with isolated worktrees, interface contracts, adversarial review, and intelligent merge | 4.4.0 |
